...
sys.stdout.write("\x1b]2;JUST BITCH IS HERE\x07")
def modifications():
...
info = """
[\033[91mSIN\033[00m] \033[91mJUST, Made By Envy, Re Coded from sinfull,
...
banner = """\033[1;00m
DONT GET IT?
YOU ARE A GOD IF YOU HAVE THIS.
...
altbanner = """
		      ...
		      Just people are punished put in hell
		     Just Meet The Cortex And Fall Into The Vortex
		      		       	C O R T E X  
"""
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;J U S T \x07")
